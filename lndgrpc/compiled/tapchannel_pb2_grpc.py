...
from lndgrpc.compiled import tapchannel_pb2 as lndgrpc_dot_compiled_dot_tapchannel__pb2
...
class TaprootAssetChannelsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FundChannel = channel.unary_unary(
                ...
                request_serializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.FundChannelRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.FundChannelResponse.FromString,
                )
        self.EncodeCustomRecords = channel.unary_unary(
                '/tapchannelrpc.TaprootAssetChannels/EncodeCustomRecords',
                request_serializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.EncodeCustomRecordsRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.EncodeCustomRecordsResponse.FromString,
                )
        self.SendPayment = channel.unary_stream(
                '/tapchannelrpc.TaprootAssetChannels/SendPayment',
                request_serializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.SendPaymentRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.SendPaymentResponse.FromString,
                )
...
def add_TaprootAssetChannelsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'FundChannel': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.FundChannelRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.FundChannelResponse.SerializeToString,
            ),
            'EncodeCustomRecords': grpc.unary_unary_rpc_method_handler(
                    servicer.EncodeCustomRecords,
                    request_deserializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.EncodeCustomRecordsRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.EncodeCustomRecordsResponse.SerializeToString,
            ),
            'SendPayment': grpc.unary_stream_rpc_method_handler(
                    servicer.SendPayment,
                    request_deserializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.SendPaymentRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_tapchannel__pb2.SendPaymentResponse.SerializeToString,
            ),
...
class TaprootAssetChannels(object):
    ...
    def FundChannel(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tapchannelrpc.TaprootAssetChannels/FundChannel',
            lndgrpc_dot_compiled_dot_tapchannel__pb2.FundChannelRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_tapchannel__pb2.FundChannelResponse.FromString,
    ...
    def EncodeCustomRecords(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tapchannelrpc.TaprootAssetChannels/EncodeCustomRecords',
            lndgrpc_dot_compiled_dot_tapchannel__pb2.EncodeCustomRecordsRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_tapchannel__pb2.EncodeCustomRecordsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SendPayment(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/tapchannelrpc.TaprootAssetChannels/SendPayment',
            lndgrpc_dot_compiled_dot_tapchannel__pb2.SendPaymentRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_tapchannel__pb2.SendPaymentResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
