...
class RfqStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddAssetBuyOrder = channel.unary_unary(
                ...
                request_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOrderRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOrderResponse.FromString,
                )
        self.AddAssetSellOrder = channel.unary_unary(
                '/rfqrpc.Rfq/AddAssetSellOrder',
                request_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOrderRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOrderResponse.FromString,
                )
        self.AddAssetSellOffer = channel.unary_unary(
                '/rfqrpc.Rfq/AddAssetSellOffer',
                request_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOfferRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOfferResponse.FromString,
                )
        self.AddAssetBuyOffer = channel.unary_unary(
                '/rfqrpc.Rfq/AddAssetBuyOffer',
                request_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOfferRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOfferResponse.FromString,
                )
        self.QueryPeerAcceptedQuotes = channel.unary_unary(
                '/rfqrpc.Rfq/QueryPeerAcceptedQuotes',
                request_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.QueryPeerAcceptedQuotesRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.QueryPeerAcceptedQuotesResponse.FromString,
                )
        self.SubscribeRfqEventNtfns = channel.unary_stream(
                '/rfqrpc.Rfq/SubscribeRfqEventNtfns',
                request_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.SubscribeRfqEventNtfnsRequest.SerializeToString,
                response_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.RfqEvent.FromString,
                )
...
def add_RfqServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddAssetBuyOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOrderRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOrderResponse.SerializeToString,
            ),
            'AddAssetSellOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.AddAssetSellOrder,
                    request_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOrderRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOrderResponse.SerializeToString,
            ),
            'AddAssetSellOffer': grpc.unary_unary_rpc_method_handler(
                    servicer.AddAssetSellOffer,
                    request_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOfferRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOfferResponse.SerializeToString,
            ),
            'AddAssetBuyOffer': grpc.unary_unary_rpc_method_handler(
                    servicer.AddAssetBuyOffer,
                    request_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOfferRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOfferResponse.SerializeToString,
            ),
            'QueryPeerAcceptedQuotes': grpc.unary_unary_rpc_method_handler(
                    servicer.QueryPeerAcceptedQuotes,
                    request_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.QueryPeerAcceptedQuotesRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.QueryPeerAcceptedQuotesResponse.SerializeToString,
            ),
            'SubscribeRfqEventNtfns': grpc.unary_stream_rpc_method_handler(
                    servicer.SubscribeRfqEventNtfns,
                    request_deserializer=lndgrpc_dot_compiled_dot_rfq__pb2.SubscribeRfqEventNtfnsRequest.FromString,
                    response_serializer=lndgrpc_dot_compiled_dot_rfq__pb2.RfqEvent.SerializeToString,
            ),
    }
...
class Rfq(object):
    ...
    def AddAssetBuyOrder(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/rfqrpc.Rfq/AddAssetBuyOrder',
            lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOrderRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOrderResponse.FromString,
    ...
    def AddAssetSellOrder(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/rfqrpc.Rfq/AddAssetSellOrder',
            lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOrderRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOrderResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def AddAssetSellOffer(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/rfqrpc.Rfq/AddAssetSellOffer',
            lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOfferRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetSellOfferResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def AddAssetBuyOffer(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/rfqrpc.Rfq/AddAssetBuyOffer',
            lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOfferRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_rfq__pb2.AddAssetBuyOfferResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def QueryPeerAcceptedQuotes(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/rfqrpc.Rfq/QueryPeerAcceptedQuotes',
            lndgrpc_dot_compiled_dot_rfq__pb2.QueryPeerAcceptedQuotesRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_rfq__pb2.QueryPeerAcceptedQuotesResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SubscribeRfqEventNtfns(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/rfqrpc.Rfq/SubscribeRfqEventNtfns',
            lndgrpc_dot_compiled_dot_rfq__pb2.SubscribeRfqEventNtfnsRequest.SerializeToString,
            lndgrpc_dot_compiled_dot_rfq__pb2.RfqEvent.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
