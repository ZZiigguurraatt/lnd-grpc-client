...
class TaprootAssetChannelsRPC(BaseClient):
    ...
    @handle_rpc_errors
    def add_taprootasset_invoice(self, asset_id, asset_amount=0, peer_pubkey=None, hodl_invoice=None, **kwargs):
        request = tapchannel.AddInvoiceRequest(asset_id=asset_id, asset_amount=asset_amount, peer_pubkey=peer_pubkey, hodl_invoice=hodl_invoice, invoice_request=lightning.Invoice(**kwargs))
